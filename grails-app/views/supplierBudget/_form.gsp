<%@ page import="mgmt.work.SupplierBudget" %>
			...
			<div class="${hasErrors(bean: supplierBudgetInstance, field: 'amount', 'has-error')} required">
				...
				<div>
					<g:field class="form-control" name="amount" value="${fieldValue(bean: supplierBudgetInstance, field: 'amount')}" required=""/>
				</div>
			</div>
			...
			<div class="${hasErrors(bean: supplierBudgetInstance, field: 'iva', 'has-error')} required">
				...
				<div>
					<g:field class="form-control" name="iva" value="${fieldValue(bean: supplierBudgetInstance, field: 'iva')}" required=""/>
				</div>
			</div>
			...
			<div class="${hasErrors(bean: supplierBudgetInstance, field: 'supplier', 'has-error')} required">
				...
				<div>
					<g:select class="form-control" id="supplier" name="supplier.id" from="${mgmt.persons.Supplier.list()}" optionKey="id" required="" value="${supplierBudgetInstance?.supplier?.id}"/>
				</div>
			</div>
			...
			<div class="${hasErrors(bean: supplierBudgetInstance, field: 'work', 'has-error')} required">
				...
				<div>
					<g:select class="form-control" id="work" name="work.id" from="${mgmt.work.Work.list()}" optionKey="id" required="" value="${supplierBudgetInstance?.work?.id}"/>
				</div>
			</div>
