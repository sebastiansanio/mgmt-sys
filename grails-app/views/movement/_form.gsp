		...
		<tbody id="items-table">
			<g:each var="movementItemInstance" in="${movementInstance?.items}" status="i">
				<tr class="form-inline" id="items-${i}">
					...
					<td class="td-intableform"><g:field onchange="refreshTotal('${i}');" type="text" class="input-intableform form-control" id="amount-${i}" name="items[${i}].amount" value="${movementItemInstance.amount}" required=""/></td>
					<td class="td-intableform"><g:field onchange="refreshTotal('${i}');" type="text" class="input-intableform form-control" id="iva-${i}" name="items[${i}].iva" value="${movementItemInstance.iva}" required=""/></td>
...
function refreshTotal(idx){
	var total = parseFloat($('#amount-'+idx).val())+ parseFloat($('#iva-'+idx).val()) + parseFloat($('#iibb-'+idx).val()) + parseFloat($('#otherPerceptions-'+idx).val());
	$('#total-'+idx).val(total);
}
