...
class BalanceController {
	...
	def show(Work work){
		...
		amounts.indirectGeneralExpenses =  work.budget.indirectOverheadPercentage? amounts.sellPrice.amount * work.budget.indirectOverheadPercentage/100 :  work.budget.indirectOverheadAmount
