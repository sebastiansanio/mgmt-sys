		...
		<tbody id="items-table">
			...
			<g:each var="itemPosition" in="${(0..((movementInstance.items.size()/2)-1))}" status="i">
				<tr class="form-inline" id="items-${itemPosition*2}">
					...
					<td class="td-intableform"><g:select class="position-0 input-intableform form-control" id="items[${itemPosition*2}].concept" name="items[${itemPosition*2}].concept.id" from="${mgmt.concept.Concept.list()}" optionKey="id" required="" value="${movementInstance.items[itemPosition*2]?.concept?.id}"/></td>
...
<table>
	<tr class="form-inline" id="item-model">
		...
		<td class="td-intableform"><g:select disabled="disabled" class="position-0 input-intableform form-control" name="items[xyz].concept.id" from="${mgmt.concept.Concept.list()}" optionKey="id" required="" value=""/></td>
